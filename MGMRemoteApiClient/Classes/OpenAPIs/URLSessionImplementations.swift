...
open class URLSessionRequestBuilder<T>: RequestBuilder<T> {
    ...
    override open func execute(_ apiResponseQueue: DispatchQueue = MGMRemoteApiClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, Error>) -> Void) {
    ...
    open func buildHeaders() -> [String: String] {
        var httpHeaders = MGMRemoteApiClientAPI.customHeaders
    ...
    func encode(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws -> URLRequest {
        ...
        for (key, value) in parameters {
            ...
            case let fileURL as URL:
                ...
                urlRequest = try configureFileUploadRequest(urlRequest: urlRequest,
                                                            boundary: boundary,
                                                            name: key,
                                                            fileURL: fileURL)
            ...
            case let string as String:
                ...
                if let data = string.data(using: .utf8) {
                    urlRequest = configureDataUploadRequest(urlRequest: urlRequest,
                                                            boundary: boundary,
                                                            name: key,
                                                            data: data)
                }
